...
describe('EditableProfileCard test', () => {
    test('mode read only should be toggled ', async () => {
        ...
        await userEvent.click(screen.getByTestId('EditProfileCardPageHeader.EditButton'));
    ...
    test('edit fields should be cleared ', async () => {
        ...
        await userEvent.click(screen.getByTestId('EditProfileCardPageHeader.CancelButton'));
    ...
    test('should be error ', async () => {
        ...
        await userEvent.click(screen.getByTestId('EditProfileCardPageHeader.EditButton'));
        await userEvent.clear(screen.getByTestId('ProfileCard.FirstName'));
        await userEvent.click(screen.getByTestId('EditProfileCardPageHeader.SaveButton'));
